...
from src.exporters.about.about_exporter import FILE_NAME, AboutExporter
from src.exporters.exporter import DATA_DIR, DATA_FILE_PREFIX


@pytest.fixture(name="exporter")
def build_exporter():
    return AboutExporter()


@patch("src.exporters.about.about_exporter.create_dir")
@patch("src.exporters.about.about_exporter.does_data_exist")
...
@patch("src.exporters.about.about_exporter.shutil")
