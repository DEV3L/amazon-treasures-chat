...
def build_exporter():
    return FilesExporter(FILE_NAME, data_directory=DATA_DIRECTORY)


@patch("src.exporters.files.files_exporter.create_dir")
@patch("src.exporters.files.files_exporter.does_data_exist")
...
@patch("src.exporters.files.files_exporter.shutil")
